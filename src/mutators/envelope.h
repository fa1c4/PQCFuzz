...
enum class AlgorithmId : uint8_t {
  ...
  kAigisSig3 = 25,
  kCrossRsdp1Fast = 64,
  kCrossRsdp1Balanced = 65,
  kCrossRsdp1Small = 66,
  kCrossRsdp3Fast = 67,
  kCrossRsdp3Balanced = 68,
  kCrossRsdp3Small = 69,
  kCrossRsdp5Fast = 70,
  kCrossRsdp5Balanced = 71,
  kCrossRsdp5Small = 72,
  kCrossRsdpg1Fast = 73,
  kCrossRsdpg1Balanced = 74,
  kCrossRsdpg1Small = 75,
  kCrossRsdpg3Fast = 76,
  kCrossRsdpg3Balanced = 77,
  kCrossRsdpg3Small = 78,
  kCrossRsdpg5Fast = 79,
...
enum class OracleId : uint8_t {
  ...
  kMlKemImplicitRejectionRelations = 46,
  kAigisEncImplicitRejectionRelations = 47,
  kMlDsaVerifyExactLengths = 48,
  kMlDsaCtxBoundaries = 49,
  kSlhDsaVerifyExactLengths = 50,
  kSlhDsaCtxBoundaries = 51,
  kMlKemRawLengthBoundary = 52,
  kMlKemEkCanonicality = 53,
  kMlDsaHintCanonicality = 54,
  kMlDsaZNormBoundary = 55,
  kMlDsaRndDeterminism = 56,
  kMlDsaPurePrehashSeparation = 57,
  kMlDsaPhOidSeparation = 58,
  kSlhDsaPurePrehashSeparation = 59,
  kSlhDsaPhOidSeparation = 60,
  kMlKemRngFailure = 61,
  kMlDsaRngFailure = 62,
  kSlhDsaRngFailure = 63,
  kCrossKat = 120,
  kCrossLocalSignVerify = 121,
  kCrossCrossVerify = 122,
  kCrossMessageKeyBinding = 123,
  kCrossExactLengths = 124,
  kCrossPackedFieldRange = 125,
  kCrossVectorPadding = 126,
  kCrossChallengeSampling = 127,
  kCrossCommitmentDigests = 128,
  kCrossDomainTranscript = 129,
  kCrossSeedRebuild = 130,
  kCrossMerkleProof = 131,
  kCrossPathProofConsumption = 132,
  kCrossKeyAlgebra = 133,
  kCrossRngReplay = 134,
  kCrossFailureResources = 135,
